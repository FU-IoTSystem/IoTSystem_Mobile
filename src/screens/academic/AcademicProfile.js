...
const AcademicProfile = ({ user, navigation }) => {
    ...
    if (!profile) {
        return (
            <AcademicLayout title="My Profile">
                            ...
                            {profile.lecturerCode && (
                                <>
                                    <View style={styles.detailItem}>
                                        <Text style={styles.detailLabel}>Staff/Lecturer Code</Text>
                                        <View style={styles.detailValueRow}>
                                            <Text style={styles.detailValue}>{profile.lecturerCode}</Text>
